...
export const TEXT_ALIGNMENTS = ["auto", "right", "center", "left"] as const;
...
export const createProjectSchema = z.object({
  ...
  font_size_scale: z.number().min(0.8).max(1.3),
  title_font_family: z.enum(FONTS),
  title_font_size_scale: z.number().min(0.8).max(1.3),
  title_text_align: z.enum(TEXT_ALIGNMENTS),
  body_text_align: z.enum(TEXT_ALIGNMENTS),
...
export const updateProjectSchema = z.object({
  ...
  font_size_scale: z.number().min(0.8).max(1.3).optional(),
  title_font_family: z.enum(FONTS).optional(),
  title_font_size_scale: z.number().min(0.8).max(1.3).optional(),
  title_text_align: z.enum(TEXT_ALIGNMENTS).optional(),
  body_text_align: z.enum(TEXT_ALIGNMENTS).optional(),
