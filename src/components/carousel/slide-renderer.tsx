...
import React, { forwardRef, useRef, useState, useEffect, type ForwardRefExoticComponent, type RefAttributes } from "react";
...
const Laqta = forwardRef<HTMLDivElement, SlideRenderProps>(function Laqta(
  { slide, palette, font, size, brandKitSettings, brandKitData, index, total, fontSizeScale: baseFontSizeScale = 1 }, ref
) {
  const isCover = slide.type === "cover";
  const isEnding = slide.type === "ending";
        ...
        {slide.imageUrl ? (
          <img
            ...
            style={{
              ...
              height: "100%",
              objectFit: "cover",
              objectPosition: LAQTA_OBJECT_POSITIONS[slide.imageFocalPosition ?? "center"],
            }}
          />
        ) : (
          <div
