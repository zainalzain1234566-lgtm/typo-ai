# Graph Report - typo  (2026-07-13)

## Corpus Check
- 119 files · ~92,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1134 nodes · 1910 edges · 219 communities (45 shown, 174 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23a88220`
...
6. `Button` - 19 edges
7. `useApp()` - 19 edges
8. `DesignerWorkspace()` - 17 edges
9. `generateTemplateAction()` - 16 edges
10. `EditorPage()` - 16 edges
...
- `Chip()` --calls--> `cn()`  [EXTRACTED]
  src/components/template-designer/designer-settings.tsx → src/lib/utils.ts
...
## Communities (219 total, 174 thin omitted)

### Community 0 - "Auth & Account Actions"
Cohesion: 0.08
Nodes (72): createFolderAction(), deleteAccountAction(), deleteFolderAction(), forgotPasswordAction(), renameFolderAction(), resetPasswordAction(), signInAction(), signOutAction() (+64 more)

### Community 1 - "Export & ZIP Pipeline"
Cohesion: 0.14
Nodes (14): ALL_LANGUAGES, ALL_TONES, demoBkSettings, demoSlide, LEVELS, SectionCard(), SECTIONS, Checkbox (+6 more)
...
Cohesion: 0.08
Nodes (35): ForgotPasswordPage(), FormData, schema, FormData, LoginContent(), schema, Pricing(), features (+27 more)

### Community 5 - "Templates Demo Data"
Cohesion: 0.09
Nodes (22): TemplateDialog(), BOLD_STATEMENT_PALETTES, CARDS_PALETTES, CLINICAL_CLEAN_PALETTES, EDITORIAL_HEALTH_PALETTES, EDITORIAL_PALETTES, getTemplate(), HERO_PALETTES (+14 more)
...
Cohesion: 0.12
Nodes (12): demoBkSettings, demoBrandKit, demoSlide, demoSlides, Examples(), faqs, features, Hero() (+4 more)

### Community 8 - "App Middleware & Fonts"
Cohesion: 0.10
Nodes (25): config, middleware(), cairo, courier, grotesk, ibm, metadata, mono (+17 more)

### Community 9 - "Wizard Steps & Brand Dialog"
Cohesion: 0.06
Nodes (38): BrandDialog(), Step1Topic(), Step2Customize(), Step3Size(), ProjectCard(), demoBkSettings, demoBrandKit, demoContent (+30 more)
...
Cohesion: 0.13
Nodes (21): createBlankProject(), fetchTemplateLookup(), FONT_DB_TO_FE, mapSlide(), projectToCreateInput(), SIZE_DB_TO_FE, slideTypeDbToFe(), TemplateLookup (+13 more)
...
Cohesion: 0.11
Nodes (19): class-variance-authority, framer-motion, html-to-image, next, dependencies, class-variance-authority, framer-motion, html-to-image (+11 more)

### Community 16 - "Projects Page & Actions"
Cohesion: 0.06
Nodes (60): auditedProviderCost(), DesignerAccess, editTemplateAction(), generateTemplateAction(), getAccess(), getMyCustomTemplatesAction(), getTemplateDesignerAccessAction(), providerCost() (+52 more)

### Community 17 - "Template Favorites & Export Step"
Cohesion: 0.14
Nodes (13): ALL_CONTENT_TYPES, ALL_LANGUAGES, ALL_TONES, CTAS, GENERAL_CONTENT_TYPES, LEVELS, MEDICAL_CONTENT_TYPES, MEDICAL_LANGUAGES (+5 more)
...
Cohesion: 0.07
Nodes (45): jszip, jszip, getCustomTemplateAction(), ExportPage(), captureAllToZip(), captureIframePng(), Chip(), DEFAULT_DESIGNER_SETTINGS (+37 more)

### Community 21 - "Slide Render Props Demo"
Cohesion: 0.16
Nodes (13): configs, demoBkSettings, demoBrandKit, slides, ScaledSlide(), SlideRenderProps, BrandKit, BrandKitSettings (+5 more)
...
Cohesion: 0.20
Nodes (9): CreateSlideInput, createSlideSchema, DuplicateSlideInput, duplicateSlideSchema, ReorderSlidesInput, reorderSlidesSchema, slideTypes, UpdateSlideInput (+1 more)
...
## Knowledge Gaps
- **570 isolated node(s):** `extends`, `next/core-web-vitals`, `@next/next/no-img-element`, `@opencode-ai/plugin`, `config` (+565 more)
...
- **What is the exact relationship between `Reset Password Page Screenshot (Issue 011 - Reset Link No Nav)` and `Issue 011: Reset Link Page Navigation Bug`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `dependencies` connect `UI Library Dependencies` to `Project Creation Schema`, `Wizard Content Options`, `page.tsx`, `version-history.tsx`, `chat-panel.tsx`, `@hookform/resolvers`, `lucide-react`, `sanitize-html`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `jszip` connect `Wizard Content Options` to `UI Library Dependencies`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._