...
## Corpus Check
- 120 files · ~93,463 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1136 nodes · 1915 edges · 218 communities (44 shown, 174 thin omitted)
...
## Communities (218 total, 174 thin omitted)

### Community 0 - "Auth & Account Actions"
Cohesion: 0.07
Nodes (76): createFolderAction(), deleteAccountAction(), deleteFolderAction(), forgotPasswordAction(), renameFolderAction(), resetPasswordAction(), signInAction(), signOutAction() (+68 more)

### Community 1 - "Export & ZIP Pipeline"
Cohesion: 0.15
Nodes (13): ALL_LANGUAGES, ALL_TONES, demoBkSettings, demoSlide, LEVELS, SectionCard(), SECTIONS, Textarea (+5 more)
...
Cohesion: 0.06
Nodes (45): ForgotPasswordPage(), FormData, schema, FormData, LoginContent(), schema, demoBkSettings, demoBrandKit (+37 more)

### Community 5 - "Templates Demo Data"
Cohesion: 0.23
Nodes (11): config, middleware(), AuthGuard(), ChatMessage, ChatPanel(), ChatPanelProps, AUTH_ROUTES, AVAILABLE_AI_MODELS (+3 more)

### Community 6 - "Slide Renderer Templates"
Cohesion: 0.05
Nodes (38): Academy, BoldStatement, BrandOverlay(), Cards, ClinicalClean, decorFont, DisclaimerFooter(), Editorial (+30 more)

### Community 8 - "App Middleware & Fonts"
Cohesion: 0.05
Nodes (42): cairo, courier, grotesk, ibm, metadata, mono, playfair, tajawal (+34 more)

### Community 9 - "Wizard Steps & Brand Dialog"
Cohesion: 0.07
Nodes (34): BrandDialog(), Step1Topic(), Step2Customize(), Step3Size(), demoBkSettings, demoBrandKit, demoContent, demoEnding (+26 more)
...
Cohesion: 0.13
Nodes (20): createBlankProject(), fetchTemplateLookup(), FONT_DB_TO_FE, FONT_FE_TO_DB, mapSlide(), SIZE_DB_TO_FE, SIZE_FE_TO_DB, slideTypeDbToFe() (+12 more)
...
Cohesion: 0.11
Nodes (19): class-variance-authority, clsx, framer-motion, next, dependencies, class-variance-authority, clsx, framer-motion (+11 more)

### Community 16 - "Projects Page & Actions"
Cohesion: 0.05
Nodes (65): auditedProviderCost(), DesignerAccess, editTemplateAction(), generateTemplateAction(), getAccess(), getMyCustomTemplatesAction(), getTemplateDesignerAccessAction(), providerCost() (+57 more)

### Community 17 - "Template Favorites & Export Step"
Cohesion: 0.12
Nodes (15): ALL_CONTENT_TYPES, ALL_LANGUAGES, ALL_TONES, CTAS, GENERAL_CONTENT_TYPES, LEVELS, MEDICAL_CONTENT_TYPES, MEDICAL_LANGUAGES (+7 more)
...
Cohesion: 0.08
Nodes (38): jszip, jszip, getCustomTemplateAction(), ExportPage(), captureAllToZip(), captureIframePng(), DesignerWorkspace(), makeClientId() (+30 more)

### Community 21 - "Slide Render Props Demo"
Cohesion: 0.18
Nodes (12): configs, demoBkSettings, demoBrandKit, slides, SlideRenderProps, BrandKit, BrandKitSettings, CarouselSize (+4 more)
...
## Knowledge Gaps
- **573 isolated node(s):** `extends`, `next/core-web-vitals`, `@next/next/no-img-element`, `@opencode-ai/plugin`, `config` (+568 more)
...
- **What is the exact relationship between `Reset Password Page Screenshot (Issue 011 - Reset Link No Nav)` and `Issue 011: Reset Link Page Navigation Bug`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `dependencies` connect `UI Library Dependencies` to `Slide CRUD Actions`, `Project Creation Schema`, `Wizard Content Options`, `page.tsx`, `version-history.tsx`, `@hookform/resolvers`, `lucide-react`, `sanitize-html`?**
